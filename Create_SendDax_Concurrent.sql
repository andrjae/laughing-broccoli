DECLARE
 v_exe_name  fnd_executables_tl.user_executable_name%TYPE := 'XXD_SEND_DAX';
 v_exe_short fnd_executables.executable_name%TYPE     :=     'XXD_SEND_DAX';
 v_exe_file  fnd_executables.execution_file_name%TYPE :=     'send_dax';
 ...
 v_prg_short fnd_concurrent_programs.concurrent_program_name%TYPE    := 'XXD_SEND_DAX';
 v_prg_name  fnd_concurrent_programs_tl.user_concurrent_program_name%TYPE  := 'AS EMT: Send to DAX';
